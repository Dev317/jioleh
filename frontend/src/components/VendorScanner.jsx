...
const Scanner = (props) => {
  ...
  return (
    <div className='flex justify-start items-center flex-col'>
      ...
      <button onClick={() => props.stop()}>stop pro</button>
    </div>
  );
};
...
export default function VendorScanner() {
    ...
    const handleScanQR = (data) => {return new Promise((resolve, reject) => {
        handleStop();
        ...
        if(url.hostname !== "jioleh.kuehbies.com") {
            ...
            const query = '*[_type == "qr_scanned" && viewer == $viewer && vendor == $vendor]';
  ...
  return (
      <div className="relative pb-2 h-full justify-center items-center">
          <Scanner onResult={(res) => {handleOnResult(res)}} stop={handleStop} />
